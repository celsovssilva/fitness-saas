    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.POST, "/api/auth/login").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/avaliacaofisica/{id}/pdf").hasAnyRole("ADMIN","PERSONAL")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/treino/{id}/pdf").hasAnyRole("ADMIN","PERSONAL")
